...
INSERT INTO `conjunto` VALUES (1,'escuela',1,0.00,23.00);
...
CREATE TABLE `detalleventaconjunto` (
  ...
  CONSTRAINT `detaVenC` FOREIGN KEY (`folioVenta`) REFERENCES `venta` (`folio`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `detalleventaprenda` (
  ...
  CONSTRAINT `detaVenP` FOREIGN KEY (`folio`) REFERENCES `venta` (`folio`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `devolucionVenta` AFTER INSERT ON `devolucionconjunto` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `devolucionVentaPrenda` AFTER INSERT ON `devolucionprenda` FOR EACH ROW begin
...
CREATE TABLE `insumoprenda` (
  ...
  CONSTRAINT `fk_insumoIP` FOREIGN KEY (`idInsumo`) REFERENCES `insumo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prendaIP` FOREIGN KEY (`idPrenda`) REFERENCES `prenda` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `prendaconjunto` (
  ...
  CONSTRAINT `conjuntoPC` FOREIGN KEY (`idConjunto`) REFERENCES `conjunto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `prendaPC` FOREIGN KEY (`idPrenda`) REFERENCES `prenda` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tienda` VALUES (2,'Rack','Rack 1',NULL);
...
CREATE TABLE `ubicacion` (
  ...
  CONSTRAINT `padreUbicacion` FOREIGN KEY (`idPadre`) REFERENCES `ubicacion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ubicacion` VALUES (1,'Estante 1','Estante',NULL);
...
INSERT INTO `usuarios` VALUES (4,'Luis','admin','1234','administrador',NULL,NULL,1,'2026-07-22 18:30:37','2026-07-22 18:30:37');
...
--
-- Dumping events for database 'textilera'
--

--
-- Dumping routines for database 'textilera'
--
...
-- Dump completed on 2026-07-28 11:46:47
